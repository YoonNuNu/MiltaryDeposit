...
public class Kn extends Calculation {
...
//      우대금리 설정
        ...
        String[] options = {
                "본 상품 가입일 현재 예금주 본인 명의 경남은행 주택청약종합저축(청년우대형 포함)을 보유중인 경우"
        };
...
//      소수점 없애기
        ...
        System.out.println("고객님의 경남은행 장병내일준비적금 만기 시 세전 금액은 " + intAmount + "입니다.");
        System.exit(0);
    }//calculate
}//class